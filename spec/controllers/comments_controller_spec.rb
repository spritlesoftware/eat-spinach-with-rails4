...
#   let(:valid_attributes) { { "note" => "MyString" } }
...
#         post :create, {:comment => { "note" => "invalid value" }}, valid_session
#         assigns(:comment).should be_a_new(Comment)
#       end
...
#         Comment.any_instance.should_receive(:update).with({ "note" => "MyString" })
#         put :update, {:id => comment.to_param, :comment => { "note" => "MyString" }}, valid_session
#       end
...
#         # Trigger the behavior that occurs when invalid params are submitted
#         Comment.any_instance.stub(:save).and_return(false)
#         put :update, {:id => comment.to_param, :comment => { "note" => "invalid value" }}, valid_session
#         assigns(:comment).should eq(comment)
#       end
